...
public class FreezeConfigContainer {
    ...
    public FreezeConfigContainer(boolean command, boolean chat, boolean interact, boolean attack, boolean damage, boolean inventory, boolean drops, boolean blocks, boolean move) {
